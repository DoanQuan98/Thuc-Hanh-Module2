...
$id = $_GET['ID'];
$sql = "SELECT Name,ProductType,Price,Amount,DateCreated,ProductDescription FROM items WHERE ID = $id";
    ...
    <form action="../function/edit.php?id=<?php echo $id ?>" method="post">
        <fieldset>
            ...
            <div class="mb-3">
                ...
                <select id="disabledSelect" class="form-select" name="type" value="<?php echo $product[0]['ProductType']; ?>">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="disabledTextInput" class="form-control" name="des" value="<?php echo $product[0]['ProductDescription']; ?>">
            </div>
